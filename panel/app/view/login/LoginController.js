...
Ext.define('djem.view.login.LoginController', {
  ...
  init: function() {
    ...
    me.getView().on('reinit', function() { me.getLoadingMask().hide(); });
  },
  ...
  onLoginClick: function() {
    ...
    (new Ext.create('Ext.data.Store', {
      ...
      data: [{ login: login.getValue(), password: password.getValue(), _token: SharedData.token }],
      proxy: { type: 'djem', suppressErrors: true, retry: false },
      listeners: {
        endupdate: function() {
